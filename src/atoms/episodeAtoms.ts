...
export const nextEpisodeAtom = atomWithStorage<{ [animeId: string]: { id: number, title: string, allEpisodes: { id: number, title: string }[] } }>('nextEpisode', {});
// saving both anime id and title
